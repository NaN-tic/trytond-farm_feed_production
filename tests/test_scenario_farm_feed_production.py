...
class Test(unittest.TestCase):
    ...
    def test(self):
        ...
        prescription_sequence = StrictSequence(name='Pig Prescriptions',
        ...
        feed_template = ProductTemplate(name='Pig Feed',
                                        default_uom=kg,
                                        type='goods',
                                        producible=True,
                                        list_price=Decimal('40'),
        ...
        feed_component1_template = ProductTemplate(name='Pig Feed Component 1',
                                                   default_uom=kg,
                                                   type='goods',
                                                   list_price=Decimal('30'),
                                                   cost_price=Decimal('20'))
        ...
        feed_component2_template = ProductTemplate(name='Pig Feed Component 2',
                                                   default_uom=kg,
                                                   type='goods',
        ...
        # Create Drug product
        drug_template = ProductTemplate(name='Drug additive',
                                        default_uom=gr,
                                        type='goods',
        ...
        veterinarian = Party(name='Veterinarian',
                             veterinarian=True,
        ...
        animal_group = AnimalGroup(specie=pigs_specie,
                                   breed=pigs_breed,
        ...
        supply_request = SupplyRequest(company=company,
        ...
        self.assertEqual(supply_request.state, 'confirmed')

        for line in supply_request.lines:
            self.assertEqual(line.quantity, line.move.quantity)
            self.assertEqual(line.quantity, line.production.quantity)
            self.assertEqual(line.move.quantity, line.production.quantity)
